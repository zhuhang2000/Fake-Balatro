...
((root) => {
  function createJokers(getState) {
    ...
    return [
      ...
      },
      {
        ...
        onHand: (ev, played) => (played.length < 5 ? { chips: (5 - played.length) * 25 } : null),
      },
      {
        id: 'goldtooth',
        name: '金牙',
  ...
  const api = { createJokers, drawJokerIcon };
  root.JokerJokers = api;
